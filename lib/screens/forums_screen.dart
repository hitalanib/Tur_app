      ...
      builder: (context, state) {
        ...
        return SafeArea(
          child: Scaffold(
            ...
            appBar: myAppBar(tittle: 'Explore',action: IconButton(
              onPressed: () {
                navigatorTo(context, SearchScreen(from: 'forums'));
              },
              icon: Icon(
                Icons.search,
                color: lightGrey,
...
Widget buildItem(context,int index,ForumModel forumModel) {
  return GestureDetector(
    onTap: (){
      navigatorTo(context, DetailsScreen(context,index,forumModel, content: forumDetails(context,forumModel), from: 'forum',));
    },
    child: Center(
      child: Padding(
          ...
          child: Stack(
            ...
            children: [
              Container(
                ...
                height:450.h,
                child: Image.network('${forumModel.coverImage}',fit: BoxFit.cover,),
              ),
              Positioned(
                top: 60,
                child: Container(
